                ...
                ${filteredItems.map(item => {
                    ...
                    <div class="p-4 flex items-center gap-4 ${item.bought ? 'opacity-50 grayscale-[0.5]' : ''} hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-all">
                        ...
                        <div class="flex items-center gap-1.5">
                            <div class="w-8 h-8 rounded-xl ${getMemberBg(member.id)} flex items-center justify-center text-sm shadow-sm ring-2 ring-white dark:ring-gray-800" title="${member.name}">${member.icon}</div>
