    ...
    <div class="fade-in">
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <div class="lg:col-span-2 grid lg:grid-cols-2 gap-6">
                ...
                <div class="grid gap-3">
                    <div class="p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-md shadow-blue-500/10 border border-blue-100 dark:border-blue-900/50 ring-1 ring-blue-50 dark:ring-blue-900/30">
                        <div class="flex items-center justify-between gap-2 mb-3">
                    ...
                    <div class="p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-md shadow-cyan-500/10 border border-cyan-100 dark:border-cyan-900/50 ring-1 ring-cyan-50 dark:ring-cyan-900/30">
                        <div class="flex items-center justify-between gap-2 mb-3">
            ...
            <div class="h-full min-h-[420px] bg-gradient-to-br from-purple-50 via-violet-50 to-fuchsia-50 dark:from-purple-900/20 dark:via-violet-900/20 dark:to-fuchsia-900/20 rounded-xl border border-purple-100 dark:border-purple-800 p-4 flex flex-col">
                ...
                <div class="grid gap-3">
                    <div class="p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-md shadow-purple-500/10 border border-purple-100 dark:border-purple-900/50 ring-1 ring-purple-50 dark:ring-purple-900/30">
                        <div class="flex items-center justify-between gap-2 mb-3">
                    ...
                    <div class="p-4 rounded-2xl bg-white dark:bg-gray-800 shadow-md shadow-violet-500/10 border border-violet-100 dark:border-violet-900/50 ring-1 ring-violet-50 dark:ring-violet-900/30">
                        <div class="flex items-center justify-between gap-2 mb-3">
